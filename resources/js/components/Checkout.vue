<template>
    ...
    export default {
        ...
        beforeMount() {
            ...
            if (localStorage.getItem('coding-challenge.jwt') != null) {
                this.user = JSON.parse(localStorage.getItem('coding-challenge.user'))
                axios.defaults.headers.common['Content-Type'] = 'application/json'
                axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('coding-challenge.jwt')
            }
        },
        methods : {
            login() {
