<template>
    ...
    export default {
        ...
        beforeMount() {
            ...
            this.user = JSON.parse(localStorage.getItem('coding-challenge.  d fuser'))
    ...
    <style scoped>
    .hero-section { height: 20vh; background: black; align-items: center; margin-bottom: 20px; margin-top: -20px; }
